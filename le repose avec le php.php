...
<header id="main-header">
    ...
    <nav>
        <ul>
            ...
            <li><a href="formulaire d'insrciption.php">conctact</a></li>
            <li><a href="connrdv.php">Make an appointment</a></li>
            <li><a href="robot_form.php">patients_Account</a></li>
            <li><a href="Connexion_medecin.php">Medecin_Account</a></li>
            <li><a href="login_ad.php">Administrator_diag_Medical</a></li>
        </ul>
    </nav>
...
<div class="container">
    <form action="" method="get">
        ...
        <a href="rendez-vous.php" class="logout-button">Quitter</a>
    </form>
